...
export function CourseHubProgress({
  ...
  return (
      ...
      <div className="mt-3 space-y-3 md:mt-4 md:space-y-4 lg:grid lg:grid-cols-[1.05fr_0.95fr] lg:gap-4">
        <CollapsePanel
          title="Índice del curso"
          subtitle="Toca para ver u ocultar módulos y lecciones"
        ...
        <CollapsePanel
          ...
          className="premium-card lg:hidden"
          bodyClassName="!pt-3"
        >
          <dl className="space-y-2 text-sm">
            <div className="flex items-center justify-between rounded-xl border border-[var(--stroke)] bg-[var(--bg-app)]/60 px-3 py-2.5">
        ...
        <aside className="premium-card hidden p-4 md:p-6 lg:block">
