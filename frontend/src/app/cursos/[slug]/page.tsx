        ...
        <div className="grid gap-0 lg:grid-cols-[1.3fr_0.7fr]">
          ...
          <div className="border-t border-[var(--stroke)] bg-[linear-gradient(160deg,#f8fafc,white)] p-6 sm:p-8 lg:border-l lg:border-t-0">
            ...
            <div className="rounded-2xl border border-[var(--stroke)] bg-white p-4">
              ...
              <p className="mt-2 text-2xl font-black text-[var(--green-700)]">
                {includedInPro ? `Incluido en ${proPlan.name}` : 'Consulta el temario'}
              </p>
              <p className="mt-1 text-sm text-[var(--ink-soft)]">
                {includedInPro
                  ? `${proPlan.name} incluye este curso. Si ya lo tienes activo, entra directamente a las lecciones.`
                  : 'Consulta el temario y solicita acceso o compra según el curso.'}
              </p>
            </div>
          </div>
        </div>
          ...
          <SurfaceCard className="p-6">
            ...
            <div className="mt-5">
              <CourseAccessLink
                hrefWhenAccess={courseEntryHref}
                hrefWhenLocked={lockedAccessHref}
                lockedLabel={includedInPro ? proPlan.ctaLabel : course.stripePaymentLink ? 'Comprar curso' : 'Solicitar acceso'}
